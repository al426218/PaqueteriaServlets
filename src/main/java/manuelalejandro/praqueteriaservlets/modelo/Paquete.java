...
public class Paquete implements Serializable {
    ...
    public JSONObject toJSON() {
        ...
        jsonPaquete.put("codPaquete", this.codPaquete);
        jsonPaquete.put("codCliente", this.codCliente);
        jsonPaquete.put("codMensajero", this.codMensajero);
        jsonPaquete.put("CPOrigen", this.CPOrigen);
        jsonPaquete.put("CPDestino", this.CPDestino);
        jsonPaquete.put("fechaEnvio", this.fechaEnvio);
        jsonPaquete.put("fechaRecogida", this.fechaRecogida);
        jsonPaquete.put("peso", this.peso);
